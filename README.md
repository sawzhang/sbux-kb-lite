...
```bash
git clone https://github.com/yourusername/sbux-kb-lite.git
cd sbux-kb-lite
pip install -r requirements.txt
# 仅 pyyaml 是必须的，anthropic 包仅在 API 模式下需要
```
...
python3 scripts/ingest.py sources/starbucks-brand-story.md
```
...
python3 scripts/query.py "什么是第三空间？"
python3 scripts/query.py "浅烘和深烘有什么区别？"
```
...
```bash
python3 scripts/query.py --json "星巴克的Logo有什么含义？"
```
